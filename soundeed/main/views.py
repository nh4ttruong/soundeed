...
def index(response):
	...
	return render(response, 'pages/index.html', {'sound': Sound.objects.all(), 'background': Background.objects.all()})

def podomoro(request):
    return render(request, 'pages/podomoro.html')
		...
		if password_reset_form.is_valid():
			...
			if associated_users.exists():
				for user in associated_users:
					...
					try:
						send_mail(subject, email, 'admin@soundeed.com' , [user.email], fail_silently=False)
